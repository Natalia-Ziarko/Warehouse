...
require_once 'core/SessionUtils.class.php';
require_once 'core/RoleUtils.class.php';
require_once 'core/ParamUtils.class.php';
...
if ($conf->clean_urls)
    $conf->action_root = $conf->app_root."/"; #for clean urls
else
    $conf->action_root = $conf->app_root.'/index.php?'.$conf->action_param.'='; #for regular urls

$conf->action_url = $conf->server_url.$conf->action_root;

App::createAndInitialize($conf); #container of fundamental system objects and wrapper for access methods